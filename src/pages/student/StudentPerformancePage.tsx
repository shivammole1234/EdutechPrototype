...
export const StudentPerformancePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-slate-100 tracking-tight">Skill Radar & Academic Analytics</h2>
        ...
        <Card>
          <CardHeader>
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Scored out of 100 on test executions</p>
            </div>
          </CardHeader>
          <div className="h-72 w-full flex items-center justify-center">
            <ResponsiveContainer width="100%" height="100%">
              <RadarChart cx="50%" cy="50%" outerRadius="75%" data={radarData}>
                ...
                <Radar name="Alex Turner" dataKey="A" stroke="#10B981" fill="#10B981" fillOpacity={0.4} />
              </RadarChart>
            </ResponsiveContainer>
          </div>
        </Card>
        ...
        <Card className="space-y-4">
          <CardHeader>
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Certificates of completion</p>
            </div>
          </CardHeader>
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3.5 bg-slate-950/70 border border-slate-800 rounded-xl flex items-center gap-3">
              ...
              <div>
                <h4 className="font-bold text-slate-100">100 Algorithms Solved</h4>
                <p className="text-slate-400">Completed 100 coding tasks with 100% test pass rate.</p>
              </div>
            </div>
            ...
            <div className="p-3.5 bg-slate-950/70 border border-slate-800 rounded-xl flex items-center gap-3">
              ...
              <div>
                <h4 className="font-bold text-slate-100">2-Week Coding Streak</h4>
                <p className="text-slate-400">Submitted at least one algorithmic solution 14 consecutive days.</p>
              </div>
            </div>
            ...
            <div className="p-3.5 bg-slate-950/70 border border-slate-800 rounded-xl flex items-center gap-3">
              ...
              <div>
                <h4 className="font-bold text-slate-100">Fast Solver Award</h4>
                <p className="text-slate-400">Solved Binary Tree Path Maximum in under 8 minutes.</p>
              </div>
            </div>
          </div>
        </Card>
...
export const StudentNotificationsPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-slate-100 tracking-tight">Notifications & Announcements</h2>
        <p className="text-xs sm:text-sm text-slate-400 mt-0.5">
        ...
        <Card className="p-4 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-sm font-semibold text-slate-100">DSA Mid-Term Examination is Live</h4>
            </div>
...
export const StudentProfilePage: React.FC = () => {
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        <h2 className="text-xl font-bold text-slate-100 tracking-tight">Learner Profile</h2>
      </div>
      ...
      <Card className="p-6 space-y-5">
        <div className="flex items-center gap-4 pb-4 border-b border-slate-800">
          ...
          />
          <div>
            <h3 className="text-lg font-bold text-slate-100">Alex Turner</h3>
            <p className="text-xs text-slate-400">alex.turner@student.codepulse.io • Student ID: CP-9942</p>
        ...
        <div className="grid grid-cols-2 gap-4 text-xs">
          ...
          <div className="p-3 bg-slate-950 rounded-lg border border-slate-800">
            <span className="text-slate-400 block mb-1">Current Academic Score:</span>
            <span className="font-semibold text-slate-200 font-mono">92.4% (Grade A)</span>
          </div>
        </div>
      </Card>
    </div>
...
export const StudentSettingsPage: React.FC = () => {
  return (
    <div className="space-y-6 max-w-xl">
      <div>
        <h2 className="text-xl font-bold text-slate-100 tracking-tight">IDE & Account Preferences</h2>
      </div>
