...
export const AdminNotificationsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-slate-100 tracking-tight">System Broadcast Center</h2>
        ...
        <Card className="lg:col-span-1 p-5 space-y-4">
          ...
          <form onSubmit={handleBroadcast} className="space-y-3 text-xs">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                rows={4}
                className="w-full bg-slate-950 border border-slate-700/80 rounded-lg px-3 py-2 text-xs text-slate-200 focus:outline-none focus:border-purple-500"
            ...
            {notifications.map((n) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-slate-400 font-mono">{formatDate(n.createdAt)}</span>
                </div>
                <p className="text-xs text-slate-300">{n.message}</p>
                <div className="text-[10px] text-purple-400 font-mono">Target: {n.role}</div>
              </div>
            ))}
          </div>
        </Card>
...
export const AdminSettingsPage: React.FC = () => {
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        <h2 className="text-xl font-bold text-slate-100 tracking-tight">Organization & Sandbox Settings</h2>
        <p className="text-xs sm:text-sm text-slate-400 mt-0.5">
      ...
      <Card className="p-6 space-y-6">
        <div className="space-y-4">
          <h3 className="text-sm font-bold text-slate-100">Judge0 Isolated Sandbox Limits</h3>
        ...
        <div className="pt-4 border-t border-slate-800 space-y-4">
          <h3 className="text-sm font-bold text-slate-100">Anti-Cheating & Proctoring Defaults</h3>
